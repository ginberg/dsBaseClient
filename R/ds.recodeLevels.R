...
#'   # this is the same as recoding level '3' as '2' whilst keeping the same 
#'   # labels for the other two levels.
#'   ds.recodeLevels(x='D$PM_BMI_CATEGORICAL', 
#'     newCategories=c('1','2','2'), newobj='BMI_CAT_NEW1')
