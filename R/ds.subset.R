...
#'   ds.dim('subD1')
#'   
#'   # Example 2: generate a subset of the assigned table (by default the table is 
#'   # named 'D') with only the variables 
...
#' 
#'   # Example 4: get the variable 'PM_BMI_CONTINUOUS' from the dataframe 'D' 
#'   # and generate a subset bmi
...
#'   # the first 50 observations of that new vector. If the specified number of row 
