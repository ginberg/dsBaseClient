...
ds.append2df(datasources=conns, quote(D), quote(lab_hdl.c))
# TODO do more than a smoke test

context("dsbaseclient::ds.append2df() append the variable 'lab_hdl.c' to 'D' and update 'D'")
ds.append2df(datasources=conns, dataset=quote(D), xvect=quote(lab_hdl.c), replace=quote(TRUE))
# TODO do more than a smoke test
