...
res <- ds.meanByClass(datasources=conns, dataset='D', outvar='LAB_HDL', covar='GENDER')
print(res)
...
res <- ds.meanByClass(datasources=conns, dataset='D', outvar=c('LAB_HDL','LAB_TSC'), covar=c('GENDER'))
print(res)
# TODO do more than a smoke test
...
res <- ds.meanByClass(datasources=conns, dataset='D', outvar=c('LAB_HDL','LAB_TSC'), covar=c('GENDER','PM_BMI_CATEGORICAL','DIS_DIAB'))
print(res)
# TODO do more than a smoke test
...
res <- ds.meanByClass(datasources=conns, dataset='D', outvar='LAB_HDL', covar='GENDER', type='split')
print(res)
# TODO do more than a smoke test
