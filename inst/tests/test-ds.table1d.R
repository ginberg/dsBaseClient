...
res <- ds.table1d(datasources=conns, xvect=quote(D$DIS_CVA))
print(res)
...
res <- ds.table1d(datasources=conns, xvect=quote(D$DIS_CVA), type="split")
print(res)
# TODO do more than a smoke test
...
res <- ds.table1d(datasources=conns[1:2], xvect=quote(D$DIS_CVA), type="split")
print(res)
# TODO do more than a smoke test
...
res <- ds.table1d(datasources=conns, xvect=quote(D$LAB_HDL)) 
print(res)
# TODO do more than a smoke test
