...
res <- ds.table2d(datasources=conns, xvect=quote(D$DIS_DIAB), yvect=quote(D$GENDER))
print(res)
...
res <- ds.table2d(datasources=conns, xvect=quote(D$DIS_DIAB), yvect=quote(D$GENDER), type="split")
print(res)
# TODO do more than a smoke test
...
res <- ds.table2d(datasources=conns[1:2], quote(D$DIS_DIAB), quote(D$GENDER), type="split")
print(res)
# TODO do more than a smoke test
...
res <- ds.table2d(datasources=conns, quote(D$DIS_CVA), quote(D$GENDER))
print(res)
# TODO do more than a smoke test
...
res <- ds.table2d(datasources=conns, quote(D$DIS_CVA), quote(D$GENDER), type="split")
print(res)
# TODO do more than a smoke test
