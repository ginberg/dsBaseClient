...
# ds.subset(datasources=conns, subset='subD', x='D', rows=c(1:50), cols=c(1,2))
# res <- ds.exists('subD')
...
# ds.subset(datasources=conns, subset='subD3', x='D', logical='PM_BMI_CONTINUOUS>=', threshold=25)
# res <- ds.exists('subD3')
...
# ds.subset(datasources=conns, subset="subLAB_HDL", x="logHDL", rows=c(1:50))
...
# ds.subset(datasources=conns, subset='subBMI', x='BMI', logical='>=', threshold=25)
